...
public class BlockBromineStationary extends BlockFluid
{
    public BlockBromineStationary(int par1, Material par2Material)
    {
	...
	public void addCreative(ArrayList itemList)
	{
