...
public class BlockRefiner extends BlockMachine
{
	private Random random = new Random();
	
	private final boolean isActive;
	
	public static boolean keepRefinerInventory = false;

	public BlockRefiner(int par1, boolean par2) 
	{
		super("Refiner", par1, Material.rock);
		isActive = par2;
	...
	{
		return ScienceCraft.registry.refinerInactive.blockID;
	}
	...
	public static void updateRefinerBlockState(boolean b, World world, int xCoord, int yCoord, int zCoord) 
	{
		...
		keepRefinerInventory = true;
		
		if(b)
		{
			world.setBlockWithNotify(xCoord, yCoord, zCoord, ScienceCraft.registry.refinerActive.blockID);
		}
		else
		{
			world.setBlockWithNotify(xCoord, yCoord, zCoord, ScienceCraft.registry.refinerInactive.blockID);
		}
		
		keepRefinerInventory = false;
